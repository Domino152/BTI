...
export default function App() {
  ...
  return <Routes>
    ...
    <Route path="/about-us" element={<AboutUs/>}/><Route path="/rti" element={<RTI/>}/><Route path="/tender" element={<Tender/>}/><Route path="/downloads" element={<Downloads/>}/><Route path="/contact-us" element={<ContactUs/>}/>
